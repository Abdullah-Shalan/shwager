 ...
 * @typedef {import('../dtos').JobDto} JobDto
 * @typedef {import('../dtos').JobResponse} JobResponse
 * @typedef {import('../dtos').JobTaskDto} JobTaskDto
 * @typedef {import('../dtos').TaskResponse} TaskResponse
 * @typedef {import('../dtos').ReorderRequest} ReorderRequest
