...
/**
 * @typedef {import('../dtos.d.ts').LoginRequest} LoginRequest
 * @typedef {import('../dtos.d.ts').CandidateRegisterRequest} CandidateRegisterRequest
 * @typedef {import('../dtos.d.ts').CandidateRegisterResponse} CandidateRegisterResponse
 * @typedef {import('../dtos.d.ts').HrRegisterRequest} HrRegisterRequest
 * @typedef {import('../dtos.d.ts').HrRegisterResponse} HrRegisterResponse
 */
